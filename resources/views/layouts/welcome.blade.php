...
<div class="flex-center position-ref full-height">
    ...
    <div class="top-right links">
        <span id="guidechimp">{{ __('views.welcome.guide') }}</span>
    ...
    <div class="content">
        ...
        <div class="footer">
            Credits:&nbsp;
            <a href="http://l64.cc/nlaff/VXZPYHCTC" target="_blank" title="Online Software License Management"><i
                    class="fa fa-lock" aria-hidden="true"></i>Labs64 NetLicensing</a>&nbsp;&bull;&nbsp;
        </div>
    </div>
</div>
